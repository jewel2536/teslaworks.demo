// Use this file to keep track of changes made to the bootswatchr.com Bootstrap theme

// HOW TO:
// 1. Paste this into bootswatchr.com/create
// 2. Make needed changes
// 3. Click "Get CSS > Minified"
// 4. Copy and paste that into bootstrap-theme.css


// ~~~~~~~~~~ PASTE BOOTSWATCHR BELOW HERE ~~~~~~~~~~
...
@font-family-serif:       Josefin Slab, Georgia, "Times New Roman", Times, serif;
...
@font-size-h1:            floor((@font-size-base * 2.5)); // ~45px
...
@navbar-default-toggle-border-color:       #333;


// Inverted navbar
// Reset inverted navbar basics
@navbar-inverse-color:                      #777;
@navbar-inverse-bg:                         #f8f8f8;
